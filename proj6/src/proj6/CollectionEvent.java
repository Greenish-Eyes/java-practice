...
public class CollectionEvent {
	//
	private static final int VOLS_NEEDED = 2;
	 ...
	 */
	public boolean sameAs (char volAvailable)
	{
	 ...
	 * the number of volunteers still needed for the event.
	 * @return the number of additional volunteers required
	 */
	public int determineVolunteersNeeded() 
	{
	    return VOLS_NEEDED - numVolunteers;
	}
	/**
	 * toString method
