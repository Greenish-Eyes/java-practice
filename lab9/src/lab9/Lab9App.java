 ...
 * <p>Description: This application reads shelter information from an input file and
 * tests the functionality of the CountyShelters class. It creates Shelter
 * objects, inserts them into a CountyShelters object, and exercises
 * the methods such as calculating available beds, registering guests,
 * and finding the most available shelter.</p>
...
public class Lab9App {
	...
	public static void main(String[] args) throws IOException
	{
		...
		if (nassauCounty.registerGuests(500) == true)
		{
			...
			System.out.println("There are not enough available beds in the county");
		...
		if (nassauCounty.registerGuests(850) == true)
		{
			System.out.println("The registration was successful \nThe current state of the county:\n"
					+ nassauCounty.toString());
		}
		 ...
		 * if the registration was successful or not AND the current state of the county
		 * shelters object */
		if (nassauCounty.registerGuests(350) == true)
		{
			System.out.println("The registration was successful \nThe current state of the county\n"
					+ nassauCounty.toString());
		}
