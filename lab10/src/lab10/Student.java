...
public class Student
{
	...
	/**
	 * equals method
	 *compare the id of this student (the object the method is called on) 
	 *to the id of the student
	 *whose reference is passed to the method (ie. the parameter)
	 * @param Student st
	 * @return true if the ids are the same
	 */
	public boolean equals(Student st)
	{
		if (this.getId().equals(st.getId()))
			return true;
		else
			return false;
	}
